...
export function NotesEditor({ content, onChange, placeholder = 'Write your notes…', maxChars }: NotesEditorProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Editor */}
      <div className="flex-1 overflow-y-auto px-3 py-2 tiptap-container text-[13px] text-[var(--text-primary)]">
